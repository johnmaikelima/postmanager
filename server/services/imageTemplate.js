    ...
    try {
      ...
      if (pageLogoUrl) {
        try {
          ...
          // Se for URL do Facebook, baixar
          else if (pageLogoUrl.startsWith('http')) {
            console.log('📥 Baixando logo do Facebook...');
            ...
            console.log('✅ Logo do Facebook convertido para base64');
          }
